    ...
    public class MouseMovement : BaseModel
    {
        ...
        public void MoveToPosition(Point destinationPosition, int milliseconds, bool drawMouse = true)
        {
            ...
            if (milliseconds <= pathPoints.Length)
            {
                ...
                var distributionIndexes = FisherYatesShuffle(Enumerable.Range(0, milliseconds).ToArray(), remainingPoints);
                var pointsUsed = 0;
            ...
            else
            {
                ...
                var distributionIndexes = FisherYatesShuffle(Enumerable.Range(0, pathPoints.Length).ToArray(), remainingMilliseconds);
